...
Grid::Grid(QPointF origin, QRectF sceneRect) : m_origin(origin), m_sceneRect(sceneRect) {
    init();
}

void Grid::update(QRectF sceneRect) {
...
QPointF Grid::snapToGrid(QPointF pos, double delta) {
...
std::vector<QLineF>& Grid::gridLines() {
    return m_gridLines;
}
